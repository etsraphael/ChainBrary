  ...
  useCaseActionCardsPayload: IUseCasesActionCard[] = [
    {
      ...
      descritpion:
        $localize`:@@useCases.bid.createBidDescription:Kickstart your bidding process with 'Create a Bid.' Tailor your bid with ease, ensuring a secure and straightforward setup. Ideal for diverse offerings, this feature simplifies launching bids on our decentralized platform.`,
    ...
    },
    {
      ...
      descritpion:
        $localize`:@@useCases.bid.joinBidDescription:Dive into existing bids with 'Join a Bid.' Find and participate in bids that align with your interests. Our platform offers a seamless and secure way to engage with the decentralized bidding community.`,
