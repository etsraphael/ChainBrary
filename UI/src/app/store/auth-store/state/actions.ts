...
export const editAccountSent = createAction('[Auth] Edit Account Sent', props<{ account: ProfileCreation }>());
...
export const addAccountSent = createAction('[Auth] Add Account Sent', props<{ account: ProfileCreation }>());
...
export const deleteAccountSent = createAction('[Auth] Delete Account Sent');
